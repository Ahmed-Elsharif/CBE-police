...
st.title("🤖 المساعد الائتماني الذكي Created by Ahmed Mostafa")
st.markdown("---")
...
أنت مستشار قانوني تلتزم **فقط** بالمراجع المقدمة إليك. 
                ...
                2. التزم **حصرياً** بالبيانات الموجودة  في [المراجع القانونية المتاحة] في ملف my_database.csv.
...
٧. اعطي المرونه في الافعال و الاسماء القريبه من بعض 
٨. لا تعطي اي اجابة من خارج المراجع المرفق
                المراجع:
                {doc_context}
